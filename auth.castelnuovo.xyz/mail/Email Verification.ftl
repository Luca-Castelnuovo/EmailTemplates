...
<p>
  <a href="http://auth.castelnuovo.xyz/email/verify/${verificationId}?tenantId=${user.tenantId}">
    https://auth.castelnuovo.xyz/email/verify/${verificationId}?tenantId=${user.tenantId}
  </a>
</p>
