...
<a href="https://auth.castelnuovo.xyz/password/forgot?email=${user.email?url}&tenantId=${user.tenantId}">
  https://auth.castelnuovo.xyz/password/forgot?email=${user.email?url}&tenantId=${user.tenantId}
</a>
